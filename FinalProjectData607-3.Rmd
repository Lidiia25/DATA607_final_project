...
ggplot(dec_final, aes(created, number)) + geom_line(aes(group=tweet, color=tweet), size=2) +
 ...
 theme(text = element_text(size=10), axis.text.x = element_text(angle=45, vjust=1)) + ggtitle(december3) + scale_x_date(name = 'date', date_breaks = '1 day', date_labels = '%D') +
 ...
 annotate("text", x = as.Date("2017-12-08"), y = 600 , label = "37°F")  + theme_igray() + scale_colour_tableau() + ylim(150, 1200)
